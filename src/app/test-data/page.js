...
export default function InputForm() {
  return (
    <div className={styles.field}>
      ...
      <UserTypeDropdown id="Usertype1" label=" User type 1 for Test case 1" />

      <UserTypeDropdown id="Usertype2" label=" User type 1 for Test case 2" />

      <UserTypeDropdown id="Usertype3" label=" User type 1 for Test case 3" />
      ...
      <CustomDatePicker id="PolicyEff" label="Policy Effective Date" />

      <CustomDatePicker id="PriorEff" label="Prior Effective Date" />

      <CustomDatePicker id="DiffEff" label="Different Effective Date" />

      <CustomDatePicker id="RateEff" label="Rate Entry Date" />
      ...
      <select id="BillingType1" name="BillingType1">
        ...
        <option value="Agency Bill Semi Yearly">Agency Bill Semi Yearly</option>
      ...
      <input disabled type="text" id="CovCd" name="CovCd" value="<PolicyCov>" />
      ...
      <input disabled type="text" id="valRWS" name="valRWS" value="<valRWS>" />
