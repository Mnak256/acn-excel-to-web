...
export default function TestGenerateButton() {
  ...
  return (
    <button onClick={downloadFile} className={styles.buttonText}>
      Generate Test case
    </button>
  );
}